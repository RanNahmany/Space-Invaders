...
dirpath = "D:\CODE\VSCode\Python SandBox\PyGame1\SpaceInvaders_Python\images"

def Content (img):
    mash = os.path.join(dirpath, img)
    return mash
...
icon = pygame.image.load(Content('Screen_Icon.png'))
pygame.display.set_icon(icon)


#Create PLayer Image
playerImg = pygame.image.load(Content("rocket.png"))
playerX = 370
playerY = 480
playerX_change = 0
...
for i in range(num_of_enemies):
    enemyImg.append(pygame.image.load(Content("ufo.png")))
